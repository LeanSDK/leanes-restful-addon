...
describe('Switch', () => {
  describe('.new', () => {
    it('should create new switch mediator', () => {
      expect(() => {
        ...
        const switchMediator = Test.NS.HttpMediator.new();
  ...
  describe('.listNotificationInterests', () => {
    it('should check handled notifications list', () => {
      expect(() => {
        ...
        const switchMediator = Test.NS.HttpMediator.new();
        switchMediator.setName(mediatorName);
        assert.deepEqual(switchMediator.listNotificationInterests(), [Test.NS.RESOURCE_RESULT], 'Function `listNotificationInterests` returns incorrect values');
      }).to.not.throw(Error);
    });
  });
  describe('.handleNotification', () => {
    it('should try handle sent notification', async () => {
      ...
      const mediatorName = 'TEST_MEDIATOR';
      const notitficationName = Test.NS.RESOURCE_RESULT;
      const notificationBody = {
        test: 'test'
      };
      const notitficationType = 'TEST_TYPE';
      const notification = Test.NS.Notification.new(notitficationName, notificationBody, notitficationType);
