...
// You should have received a copy of the GNU Lesser General Public License
// along with leanes-restful-addon.  If not, see <https://www.gnu.org/licenses/>.
const RouteOptionsT = globalContext$2.type("RouteOptionsT", globalContext$2.object(globalContext$2.property("to", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("at", globalContext$2.nullable(globalContext$2.union(globalContext$2.string("collection"), globalContext$2.string("member")))), globalContext$2.property("resource", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("action", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("tag", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("template", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("keyName", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("entityName", globalContext$2.nullable(globalContext$2.string())), globalContext$2.property("recordName", globalContext$2.nullable(globalContext$2.string()))));
...
var TemplatableModule = (Module => {
  ...
  return ['TemplatableModule', BaseClass => {
    ...
    }), _class2), _applyDecoratedDescriptor(_class2.prototype, "Templates", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "Templates"), _class2.prototype), _applyDecoratedDescriptor(_class2, "templates", [method], Object.getOwnPropertyDescriptor(_class2, "templates"), _class2), _applyDecoratedDescriptor(_class2, "defineTemplate", [method], Object.getOwnPropertyDescriptor(_class2, "defineTemplate"), _class2), _applyDecoratedDescriptor(_class2, "resolveTemplate", [method], Object.getOwnPropertyDescriptor(_class2, "resolveTemplate"), _class2)), _class2)) || _class) || _class);
